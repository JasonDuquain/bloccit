  ...
  describe("GET /advertisements", () => {
    it("should return a status code 200 and all advertisements", (done) => {
      request.get(base, (err, res, body) => {
        ...
        expect(body).toContain("Test Advertisement");
        done();
      });
    });
  });
  ...
  describe("POST /advertisements/create", () => {
    ...
    it("should create a new advertisement and redirect", (done) => {
      request.post(options, (err, res, body) => {
        Advertisement.findOne({where: {title: "Test Advert 1"}})
        .then((advertisement) => {
          expect(res.statusCode).toBe(303);
          expect(advertisement.title).toBe("Test Advert 1");
          expect(advertisement.description).toBe("This is a test advert");
          done();
        })
        .catch((err) => {
          console.log(err);
  ...
  describe("POST /advertisements/:id/udpate", () => {
    it("should update the advertisement with the given values", (done) => {
      ...
      request.post(options, (err, res, body) => {
        ...
        .then((advertisement) => {
          expect(advertisement.title).toBe("Test Advertisement");
          done();
        });
      });
    });
